...
class HXCPP_CLASS_ATTRIBUTES ArrayBufferView_obj : public ::hx::Object
{
	...
	public:
		...
		static void transferElement( ::lime::utils::ArrayBufferView fromView,int fromIndex, ::lime::utils::ArrayBufferView toView,int toIndex);
		static ::Dynamic transferElement_dyn();
