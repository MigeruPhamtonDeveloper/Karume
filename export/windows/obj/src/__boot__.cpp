...
::start::PetalParticle_obj::__register();
::start::MenuState_obj::__register();
::rooms::RoomTest_obj::__register();
::play::PlayState_obj::__register();
...
::characters::Karume_obj::__register();
