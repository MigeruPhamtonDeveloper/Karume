...
HXDLIN( 130)							 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (yi - 1)),(val & 255));
            						}
HXLINE( 131)						{
HXLINE( 131)							yi = (yi + 1);
HXDLIN( 131)							int val1 = ::hx::UShr((g * ms),ss);
HXDLIN( 131)							 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (yi - 1)),(val1 & 255));
            						}
HXLINE( 132)						{
HXLINE( 132)							yi = (yi + 1);
HXDLIN( 132)							int val2 = ::hx::UShr((b * ms),ss);
HXDLIN( 132)							 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (yi - 1)),(val2 & 255));
            						}
HXLINE( 133)						{
HXLINE( 133)							yi = (yi + 1);
HXDLIN( 133)							int val3 = ::hx::UShr((a * ms),ss);
HXDLIN( 133)							 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (yi - 1)),(val3 & 255));
            						}
HXLINE( 134)						int p2;
...
HXDLIN( 185)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 3)),(val4 & 255));
            							}
HXLINE( 186)							if ((pa > 0)) {
HXLINE( 188)								{
HXLINE( 188)									int val5 = ::hx::UShr((r * ms),ss);
HXDLIN( 188)									 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + p),(val5 & 255));
            								}
HXLINE( 189)								{
HXLINE( 189)									int val6 = ::hx::UShr((g * ms),ss);
HXDLIN( 189)									 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 1)),(val6 & 255));
            								}
HXLINE( 190)								{
HXLINE( 190)									int val7 = ::hx::UShr((b * ms),ss);
HXDLIN( 190)									 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 2)),(val7 & 255));
            								}
            							}
            							else {
HXLINE( 194)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 2)),(0 & 255));
HXDLIN( 194)								int val8 = 0;
HXDLIN( 194)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 1)),(val8 & 255));
HXDLIN( 194)								int val9 = val8;
HXDLIN( 194)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + p),(val9 & 255));
            							}
HXLINE( 196)							int p3;
...
HXDLIN( 210)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 3)),(val10 & 255));
            							}
HXLINE( 211)							if ((pa > 0)) {
...
HXDLIN( 217)									 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + p),(val11 & 255));
            								}
HXLINE( 218)								{
...
HXDLIN( 218)									 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 1)),(val12 & 255));
            								}
HXLINE( 219)								{
...
HXDLIN( 219)									 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 2)),(val13 & 255));
            								}
            							}
            							else {
HXLINE( 223)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 2)),(0 & 255));
HXDLIN( 223)								int val14 = 0;
HXDLIN( 223)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 1)),(val14 & 255));
HXDLIN( 223)								int val15 = val14;
HXDLIN( 223)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + p),(val15 & 255));
            							}
HXLINE( 225)							int p4;
