...
HX_LOCAL_STACK_FRAME(_hx_pos_43b917087f5df710_575_getInt16,"lime.utils.ArrayBufferIO","getInt16",0x764c5d83,"lime.utils.ArrayBufferIO.getInt16","lime/utils/ArrayBufferView.hx",575,0xb543acf8)
HX_LOCAL_STACK_FRAME(_hx_pos_43b917087f5df710_587_getInt16_BE,"lime.utils.ArrayBufferIO","getInt16_BE",0x50eb063f,"lime.utils.ArrayBufferIO.getInt16_BE","lime/utils/ArrayBufferView.hx",587,0xb543acf8)
HX_LOCAL_STACK_FRAME(_hx_pos_43b917087f5df710_605_setInt16,"lime.utils.ArrayBufferIO","setInt16",0x24a9b6f7,"lime.utils.ArrayBufferIO.setInt16","lime/utils/ArrayBufferView.hx",605,0xb543acf8)
HX_LOCAL_STACK_FRAME(_hx_pos_43b917087f5df710_618_setInt16_BE,"lime.utils.ArrayBufferIO","setInt16_BE",0x5b580d4b,"lime.utils.ArrayBufferIO.setInt16_BE","lime/utils/ArrayBufferView.hx",618,0xb543acf8)
namespace lime{
namespace utils{
...
int ArrayBufferIO_obj::getInt16( ::haxe::io::Bytes buffer,int byteOffset){
            	HX_STACKFRAME(&_hx_pos_43b917087f5df710_575_getInt16)
HXDLIN( 575)		return  ::__hxcpp_memory_get_i16(buffer->b,byteOffset);
            	}
...
int ArrayBufferIO_obj::getInt16_BE( ::haxe::io::Bytes buffer,int byteOffset){
            	HX_STACKFRAME(&_hx_pos_43b917087f5df710_587_getInt16_BE)
HXLINE( 589)		::Array< unsigned char > bufferData = buffer->b;
HXLINE( 590)		int ch1 = ( ::__hxcpp_memory_get_byte(bufferData,byteOffset) & 255);
HXLINE( 591)		int ch2 = ( ::__hxcpp_memory_get_byte(bufferData,(byteOffset + 1)) & 255);
HXLINE( 592)		int val = ((ch1 << 8) | ch2);
HXLINE( 593)		if (((val & 32768) != 0)) {
HXLINE( 593)			return (val - 65536);
            		}
            		else {
HXLINE( 593)			return val;
            		}
HXDLIN( 593)		return 0;
            	}
...
void ArrayBufferIO_obj::setInt16( ::haxe::io::Bytes buffer,int byteOffset,int value){
            	HX_STACKFRAME(&_hx_pos_43b917087f5df710_605_setInt16)
HXDLIN( 605)		 ::__hxcpp_memory_set_i16(buffer->b,byteOffset,value);
            	}
...
void ArrayBufferIO_obj::setInt16_BE( ::haxe::io::Bytes buffer,int byteOffset,int value){
            	HX_STACKFRAME(&_hx_pos_43b917087f5df710_618_setInt16_BE)
HXLINE( 620)		::Array< unsigned char > bufferData = buffer->b;
HXLINE( 621)		 ::__hxcpp_memory_set_byte(bufferData,byteOffset,((value >> 8) & 255));
HXLINE( 622)		 ::__hxcpp_memory_set_byte(bufferData,(byteOffset + 1),(value & 255));
            	}
