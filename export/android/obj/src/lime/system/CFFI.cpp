...
HX_LOCAL_STACK_FRAME(_hx_pos_9b11a74d7222574a_327___sysName,"lime.system.CFFI","__sysName",0x178f5196,"lime.system.CFFI.__sysName","lime/system/CFFI.hx",327,0x441ad672)
HX_LOCAL_STACK_FRAME(_hx_pos_9b11a74d7222574a_341___tryLoad,"lime.system.CFFI","__tryLoad",0xe7c4e49f,"lime.system.CFFI.__tryLoad","lime/system/CFFI.hx",341,0x441ad672)
...
::String CFFI_obj::_hx___sysName(){
            	HX_STACKFRAME(&_hx_pos_9b11a74d7222574a_327___sysName)
HXLINE( 330)		 ::Dynamic sys_string = ::cpp::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("sys_string",03,f9,de,46),0);
HXLINE( 331)		return ( (::String)(sys_string()) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(CFFI_obj,_hx___sysName,return )
 ...
 ::Dynamic CFFI_obj::_hx___tryLoad(::String name,::String library,::String func,int args){
            	HX_STACKFRAME(&_hx_pos_9b11a74d7222574a_341___tryLoad)
HXLINE( 343)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 346)			 ::Dynamic result = ::cpp::Lib_obj::load(name,func,args);
HXLINE( 359)			if (::hx::IsNotNull( result )) {
HXLINE( 361)				::lime::_hx_system::CFFI_obj::_hx___loaderTrace((HX_("Got result ",af,e9,02,45) + name));
HXLINE( 362)				::lime::_hx_system::CFFI_obj::_hx___moduleNames->set(library,name);
...
HXLINE( 368)				::lime::_hx_system::CFFI_obj::_hx___loaderTrace((HX_("Failed to load : ",1e,ca,38,9b) + name));
            			}
            			else {
            				HX_STACK_DO_THROW(_hx_e);
            			}
