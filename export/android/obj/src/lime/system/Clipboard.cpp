...
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_94_set_text,"lime.system.Clipboard","set_text",0x94a53ce8,"lime.system.Clipboard.set_text","lime/system/Clipboard.hx",94,0x9490b5ee)
...
HXLINE(  67)		::lime::_hx_system::Clipboard_obj::_hx___update();
HXLINE(  90)		return ::lime::_hx_system::Clipboard_obj::_text;
            	}
...
::String Clipboard_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_94_set_text)
HXLINE(  95)		::String cacheText = ::lime::_hx_system::Clipboard_obj::_text;
HXLINE(  96)		::lime::_hx_system::Clipboard_obj::_text = value;
HXLINE(  99)		::lime::_internal::backend::native::NativeCFFI_obj::lime_clipboard_set_text(value);
HXLINE( 110)		if ((::lime::_hx_system::Clipboard_obj::_text != cacheText)) {
HXLINE( 112)			::lime::_hx_system::Clipboard_obj::onUpdate->dispatch();
            		}
