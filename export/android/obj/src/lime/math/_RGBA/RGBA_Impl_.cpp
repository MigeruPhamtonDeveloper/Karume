...
HXDLIN(  66)					 ::__hxcpp_memory_set_byte(this2->buffer->b,(this2->byteOffset + i1),(i1 & 255));
            				}
            			}
            		}
HXLINE(  69)		{
...
HXDLIN(  71)					 ::__hxcpp_memory_set_byte(this3->buffer->b,(this3->byteOffset + i2),(255 & 255));
            				}
            			}
            		}
            	}
...
HXDLIN( 217)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),(val & 255));
            				}
HXLINE( 218)				{
HXLINE( 218)					int val1 = (::hx::UShr(this1,16) & 255);
HXDLIN( 218)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),(val1 & 255));
            				}
HXLINE( 219)				{
HXLINE( 219)					int val2 = (::hx::UShr(this1,8) & 255);
HXDLIN( 219)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),(val2 & 255));
            				}
HXLINE( 220)				{
HXLINE( 220)					int val3 = (this1 & 255);
HXDLIN( 220)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),(val3 & 255));
            				}
            			}
            			break;
            			case (int)1: {
...
HXDLIN( 223)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),(val4 & 255));
            				}
HXLINE( 224)				{
HXLINE( 224)					int val5 = (::hx::UShr(this1,24) & 255);
HXDLIN( 224)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),(val5 & 255));
            				}
HXLINE( 225)				{
HXLINE( 225)					int val6 = (::hx::UShr(this1,16) & 255);
HXDLIN( 225)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),(val6 & 255));
            				}
HXLINE( 226)				{
HXLINE( 226)					int val7 = (::hx::UShr(this1,8) & 255);
HXDLIN( 226)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),(val7 & 255));
            				}
            			}
            			break;
            			case (int)2: {
...
HXDLIN( 211)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),(val8 & 255));
            				}
HXLINE( 212)				{
HXLINE( 212)					int val9 = (::hx::UShr(this1,16) & 255);
HXDLIN( 212)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),(val9 & 255));
            				}
HXLINE( 213)				{
HXLINE( 213)					int val10 = (::hx::UShr(this1,24) & 255);
HXDLIN( 213)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),(val10 & 255));
            				}
HXLINE( 214)				{
HXLINE( 214)					int val11 = (this1 & 255);
HXDLIN( 214)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),(val11 & 255));
            				}
            			}
            			break;
            		}
