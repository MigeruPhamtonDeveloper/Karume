...
HXDLIN( 161)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),(val & 255));
            				}
HXLINE( 162)				{
HXLINE( 162)					int val1 = (::hx::UShr(this1,8) & 255);
HXDLIN( 162)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),(val1 & 255));
            				}
HXLINE( 163)				{
HXLINE( 163)					int val2 = (this1 & 255);
HXDLIN( 163)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),(val2 & 255));
            				}
HXLINE( 164)				{
HXLINE( 164)					int val3 = (::hx::UShr(this1,24) & 255);
HXDLIN( 164)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),(val3 & 255));
            				}
            			}
            			break;
            			case (int)1: {
...
HXDLIN( 167)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),(val4 & 255));
            				}
HXLINE( 168)				{
HXLINE( 168)					int val5 = (::hx::UShr(this1,16) & 255);
HXDLIN( 168)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),(val5 & 255));
            				}
HXLINE( 169)				{
HXLINE( 169)					int val6 = (::hx::UShr(this1,8) & 255);
HXDLIN( 169)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),(val6 & 255));
            				}
HXLINE( 170)				{
HXLINE( 170)					int val7 = (this1 & 255);
HXDLIN( 170)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),(val7 & 255));
            				}
            			}
            			break;
            			case (int)2: {
...
HXDLIN( 155)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),(val8 & 255));
            				}
HXLINE( 156)				{
HXLINE( 156)					int val9 = (::hx::UShr(this1,8) & 255);
HXDLIN( 156)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),(val9 & 255));
            				}
HXLINE( 157)				{
HXLINE( 157)					int val10 = (::hx::UShr(this1,16) & 255);
HXDLIN( 157)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),(val10 & 255));
            				}
HXLINE( 158)				{
HXLINE( 158)					int val11 = (::hx::UShr(this1,24) & 255);
HXDLIN( 158)					 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),(val11 & 255));
            				}
            			}
            			break;
            		}
