...
HXLINE( 184)			 ::Dynamic _g;
HXDLIN( 184)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 184)				 ::openfl::net::SharedObject obj = ::openfl::net::SharedObject_obj::getLocal(name,path,null());
HXDLIN( 184)				_g = ::flixel::util::LoadResult_obj::SUCCESS(obj);
            			} catch( ::Dynamic _hx_e) {
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g1 = _hx_e;
HXLINE( 440)					 ::haxe::Exception e = ::haxe::Exception_obj::caught(_g1);
HXLINE( 184)					_g = ::flixel::util::LoadResult_obj::FAILURE(::flixel::util::LoadFailureType_obj::IO(e),null());
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
            				}
            			}
HXDLIN( 184)			 ::flixel::util::LoadResult _g2 = _g;
HXDLIN( 184)			switch((int)(_g2->_hx_getIndex())){
            				case (int)0: {
HXLINE( 186)					 ::openfl::net::SharedObject sharedObject = _g2->_hx_getObject(0).StaticCast<  ::openfl::net::SharedObject >();
...
HXLINE( 190)					return true;
            				...
            				break;
            				case (int)1: {
HXLINE( 208)					 ::flixel::util::LoadFailureType _g3 = _g2->_hx_getObject(0).StaticCast<  ::flixel::util::LoadFailureType >();
HXDLIN( 208)					 ::openfl::net::SharedObject _g4 = _g2->_hx_getObject(1).StaticCast<  ::openfl::net::SharedObject >();
HXDLIN( 208)					if ((_g3->_hx_getIndex() == 3)) {
HXLINE( 192)						::String rawData = _g3->_hx_getString(0);
HXDLIN( 192)						 ::haxe::Exception exception = _g3->_hx_getObject(1).StaticCast<  ::haxe::Exception >();
HXDLIN( 192)						 ::openfl::net::SharedObject sharedObject1 = _g4;
...
HXLINE( 208)							 ::flixel::util::LoadFailureType type = _g3;
HXDLIN( 208)							 ::openfl::net::SharedObject sharedObject2 = _g4;
...
HXLINE( 208)						 ::flixel::util::LoadFailureType type1 = _g3;
HXDLIN( 208)						 ::openfl::net::SharedObject sharedObject3 = _g4;
...
HXLINE( 211)						return false;
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g5 = _hx_e;
HXLINE( 214)				 ::haxe::Exception e1 = ::haxe::Exception_obj::caught(_g5);
HXLINE( 216)				{
HXLINE( 216)					 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 216)					 ::Dynamic data = ((((((HX_("Error:",92,f7,fc,85) + e1->get_message()) + HX_(" name:\"",d3,e5,27,50)) + name) + HX_("\", path:\"",23,f3,3c,fa)) + path) + HX_("\".",cc,1d,00,00));
