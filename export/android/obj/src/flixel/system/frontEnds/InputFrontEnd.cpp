...
HX_LOCAL_STACK_FRAME(_hx_pos_ff18a02f3055fb45_38_addInput_flixel_input_android_FlxAndroidKeys,"flixel.system.frontEnds.InputFrontEnd","addInput_flixel_input_android_FlxAndroidKeys",0x32c010ef,"flixel.system.frontEnds.InputFrontEnd.addInput_flixel_input_android_FlxAndroidKeys","flixel/system/frontEnds/InputFrontEnd.hx",38,0x759f67bd)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ff18a02f3055fb45_38_addInput_flixel_input_touch_FlxTouchManager,"flixel.system.frontEnds.InputFrontEnd","addInput_flixel_input_touch_FlxTouchManager",0x5385b6d2,"flixel.system.frontEnds.InputFrontEnd.addInput_flixel_input_touch_FlxTouchManager","flixel/system/frontEnds/InputFrontEnd.hx",38,0x759f67bd)
...
HX_DEFINE_DYNAMIC_FUNC1(InputFrontEnd_obj,addUniqueType_add_T,return )
 ...
 ::flixel::input::android::FlxAndroidKeys InputFrontEnd_obj::addInput_flixel_input_android_FlxAndroidKeys( ::flixel::input::android::FlxAndroidKeys input){
            	HX_STACKFRAME(&_hx_pos_ff18a02f3055fb45_38_addInput_flixel_input_android_FlxAndroidKeys)
...
HX_DEFINE_DYNAMIC_FUNC1(InputFrontEnd_obj,addInput_flixel_input_android_FlxAndroidKeys,return )
...
HX_DEFINE_DYNAMIC_FUNC1(InputFrontEnd_obj,addInput_flixel_input_gamepad_FlxGamepadManager,return )
 ...
 ::flixel::input::touch::FlxTouchManager InputFrontEnd_obj::addInput_flixel_input_touch_FlxTouchManager( ::flixel::input::touch::FlxTouchManager input){
            	HX_STACKFRAME(&_hx_pos_ff18a02f3055fb45_38_addInput_flixel_input_touch_FlxTouchManager)
HXLINE(  39)		if (!(this->list->contains(input))) {
HXLINE(  40)			this->list->push(input);
            		}
HXLINE(  42)		return input;
...
HX_DEFINE_DYNAMIC_FUNC1(InputFrontEnd_obj,addInput_flixel_input_touch_FlxTouchManager,return )
...
::hx::Val InputFrontEnd_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 19:
		...
		break;
	case 43:
		if (HX_FIELD_EQ(inName,"addInput_flixel_input_touch_FlxTouchManager") ) { return ::hx::Val( addInput_flixel_input_touch_FlxTouchManager_dyn() ); }
		break;
	case 44:
		if (HX_FIELD_EQ(inName,"addInput_flixel_input_android_FlxAndroidKeys") ) { return ::hx::Val( addInput_flixel_input_android_FlxAndroidKeys_dyn() ); }
		break;
	case 47:
...
static ::String InputFrontEnd_obj_sMemberFields[] = {
	...
	HX_("addInput_flixel_input_android_FlxAndroidKeys",63,19,21,9e),
	HX_("addInput_flixel_input_gamepad_FlxGamepadManager",1e,21,e4,be),
	HX_("addInput_flixel_input_touch_FlxTouchManager",de,78,ce,a7),
