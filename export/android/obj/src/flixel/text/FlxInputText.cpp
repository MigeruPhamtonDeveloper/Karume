...
static const ::String _hx_array_data_89ec60f4_106[] = {
...
HXLINE( 502)		this->_currentTouch = null();
...
HXLINE(1520)		if (::hx::IsNotNull( this->_currentTouch )) {
HXLINE(1522)			this->updatePointerDrag(this->_currentTouch,elapsed);
HXLINE(1524)			bool _hx_tmp;
HXDLIN(1524)			if (::hx::IsEq( this->_lastTouchX,this->_currentTouch->x )) {
HXLINE(1524)				_hx_tmp = ::hx::IsNotEq( this->_lastTouchY,this->_currentTouch->y );
            			}
            			else {
HXLINE(1524)				_hx_tmp = true;
            			}
HXDLIN(1524)			if (_hx_tmp) {
HXLINE(1526)				this->updatePointerMove(this->_currentTouch);
HXLINE(1527)				this->_lastTouchX = this->_currentTouch->x;
HXLINE(1528)				this->_lastTouchY = this->_currentTouch->y;
            			}
HXLINE(1531)			 ::flixel::input::FlxInput _this = this->_currentTouch->input;
HXDLIN(1531)			bool _hx_tmp1;
HXDLIN(1531)			if ((_this->current != 0)) {
HXLINE(1531)				_hx_tmp1 = (_this->current == -1);
            			}
            			else {
HXLINE(1531)				_hx_tmp1 = true;
            			}
HXDLIN(1531)			if (_hx_tmp1) {
HXLINE(1533)				this->updatePointerRelease(this->_currentTouch);
HXLINE(1534)				this->_currentTouch = null();
HXLINE(1535)				this->_lastTouchY = (this->_lastTouchX = null());
            			}
            		}
HXLINE(1539)		bool pressedElsewhere = false;
HXLINE(1540)		{
HXLINE(1540)			int _g = 0;
HXDLIN(1540)			::Array< ::Dynamic> _g1 = ::flixel::FlxG_obj::touches->list;
HXDLIN(1540)			while((_g < _g1->length)){
HXLINE(1540)				 ::flixel::input::touch::FlxTouch touch = _g1->__get(_g).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXDLIN(1540)				_g = (_g + 1);
HXLINE(1542)				if (this->checkPointerOverlap(touch)) {
HXLINE(1544)					overlap = true;
HXLINE(1545)					bool _hx_tmp2;
HXDLIN(1545)					if ((touch->input->current == 2)) {
HXLINE(1545)						_hx_tmp2 = this->selectable;
            					}
            					else {
HXLINE(1545)						_hx_tmp2 = false;
            					}
HXDLIN(1545)					if (_hx_tmp2) {
HXLINE(1547)						this->_currentTouch = touch;
HXLINE(1548)						this->_lastTouchX = touch->x;
HXLINE(1549)						this->_lastTouchY = touch->y;
HXLINE(1550)						this->updatePointerPress(touch);
            					}
HXLINE(1552)					goto _hx_goto_51;
            				}
            				else {
HXLINE(1554)					if ((touch->input->current == 2)) {
HXLINE(1556)						pressedElsewhere = true;
HXLINE(1557)						this->_lastPressTime = 0;
            					}
            				}
            			}
            			_hx_goto_51:;
...
HXDLIN(1560)		if (pressedElsewhere) {
HXLINE(1560)			_hx_tmp4 = ::hx::IsNull( this->_currentTouch );
            		}
            		else {
HXLINE(1560)			_hx_tmp4 = false;
            		}
HXDLIN(1560)		if (_hx_tmp4) {
HXLINE(1560)			_hx_tmp3 = !(this->_justGainedFocus);
            		}
            		else {
HXLINE(1560)			_hx_tmp3 = false;
            		}
HXDLIN(1560)		if (_hx_tmp3) {
HXLINE(1562)			this->endFocus();
            		}
...
void FlxInputText_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(_lastTouchX,"_lastTouchX");
	HX_MARK_MEMBER_NAME(_lastTouchY,"_lastTouchY");
...
void FlxInputText_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(_lastTouchX,"_lastTouchX");
	HX_VISIT_MEMBER_NAME(_lastTouchY,"_lastTouchY");
...
::hx::Val FlxInputText_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"_lastTouchX") ) { return ::hx::Val( _lastTouchX ); }
		if (HX_FIELD_EQ(inName,"_lastTouchY") ) { return ::hx::Val( _lastTouchY ); }
...
::hx::Val FlxInputText_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"_lastTouchX") ) { _lastTouchX=inValue.Cast<  ::Dynamic >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_lastTouchY") ) { _lastTouchY=inValue.Cast<  ::Dynamic >(); return inValue; }
		break;
	case 12:
...
void FlxInputText_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("_lastTouchX",ce,5f,e6,35));
	outFields->push(HX_("_lastTouchY",cf,5f,e6,35));
...
static ::hx::StorageInfo FlxInputText_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::input::touch::FlxTouch */ ,(int)offsetof(FlxInputText_obj,_currentTouch),HX_("_currentTouch",a5,8f,ad,3d)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(FlxInputText_obj,_lastTouchX),HX_("_lastTouchX",ce,5f,e6,35)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(FlxInputText_obj,_lastTouchY),HX_("_lastTouchY",cf,5f,e6,35)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String FlxInputText_obj_sMemberFields[] = {
	...
	HX_("_lastTouchX",ce,5f,e6,35),
	HX_("_lastTouchY",cf,5f,e6,35),
...
HXDLIN(  40)		DELIMITERS = ::Array_obj< ::String >::fromData( _hx_array_data_89ec60f4_106,13);
            	}
}
