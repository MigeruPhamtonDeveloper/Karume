...
HXLINE( 100)			Float dx = ((Source->x + Source->origin->x) - ( (Float)(Touch->viewX) ));
HXDLIN( 100)			Float dy = ((Source->y + Source->origin->y) - ( (Float)(Touch->viewY) ));
...
HXLINE( 284)			source->velocity->set(0,0);
            		}
HXLINE( 286)		source->acceleration->set((cosA * acceleration),(sinA * acceleration));
HXLINE( 287)		source->maxVelocity->set(::Math_obj::abs((cosA * maxSpeed)),::Math_obj::abs((sinA * maxSpeed)));
            	}
