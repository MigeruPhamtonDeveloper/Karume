...
HX_LOCAL_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_448_distanceToTouch,"flixel.math.FlxMath","distanceToTouch",0xd2645107,"flixel.math.FlxMath.distanceToTouch","flixel/math/FlxMath.hx",448,0x837802f8)
HX_LOCAL_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_464_isDistanceToTouchWithin,"flixel.math.FlxMath","isDistanceToTouchWithin",0x33e8e188,"flixel.math.FlxMath.isDistanceToTouchWithin","flixel/math/FlxMath.hx",464,0x837802f8)
...
int FlxMath_obj::distanceToTouch( ::flixel::FlxSprite Sprite, ::flixel::input::touch::FlxTouch Touch){
            	HX_STACKFRAME(&_hx_pos_5d39d2fff62ba7b8_448_distanceToTouch)
HXLINE( 449)		Float dx = ((Sprite->x + Sprite->origin->x) - ( (Float)(Touch->viewX) ));
HXLINE( 450)		Float dy = ((Sprite->y + Sprite->origin->y) - ( (Float)(Touch->viewY) ));
HXLINE( 451)		return ::Std_obj::_hx_int(::Math_obj::sqrt(((dx * dx) + (dy * dy))));
            	}
...
bool FlxMath_obj::isDistanceToTouchWithin( ::flixel::FlxSprite Sprite, ::flixel::input::touch::FlxTouch Touch,Float Distance,::hx::Null< bool >  __o_IncludeEqual){
            		bool IncludeEqual = __o_IncludeEqual.Default(false);
            	HX_STACKFRAME(&_hx_pos_5d39d2fff62ba7b8_464_isDistanceToTouchWithin)
HXLINE( 465)		Float dx = ((Sprite->x + Sprite->origin->x) - ( (Float)(Touch->viewX) ));
HXLINE( 466)		Float dy = ((Sprite->y + Sprite->origin->y) - ( (Float)(Touch->viewY) ));
HXLINE( 468)		if (IncludeEqual) {
HXLINE( 469)			return (((dx * dx) + (dy * dy)) <= (Distance * Distance));
            		}
            		else {
HXLINE( 471)			return (((dx * dx) + (dy * dy)) < (Distance * Distance));
            		}
