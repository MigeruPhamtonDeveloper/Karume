...
HXDLIN(  15)		return this->keyManager->checkStatusUnsafe((int)1073742094,this->status);
            	}
...
HXDLIN(  20)		return this->keyManager->checkStatusUnsafe((int)1073742092,this->status);
            	}
