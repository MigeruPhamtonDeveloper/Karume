...
HX_LOCAL_STACK_FRAME(_hx_pos_37f2223600af1802_20_fromString,"flixel.input.android._FlxAndroidKey.FlxAndroidKey_Impl_","fromString",0xb5388f3d,"flixel.input.android._FlxAndroidKey.FlxAndroidKey_Impl_.fromString","flixel/input/android/FlxAndroidKey.hx",20,0xd13214f4)
HX_LOCAL_STACK_FRAME(_hx_pos_37f2223600af1802_28_toString,"flixel.input.android._FlxAndroidKey.FlxAndroidKey_Impl_","toString",0x27c6b58e,"flixel.input.android._FlxAndroidKey.FlxAndroidKey_Impl_.toString","flixel/input/android/FlxAndroidKey.hx",28,0xd13214f4)
...
HX_LOCAL_STACK_FRAME(_hx_pos_37f2223600af1802_13_boot,"flixel.input.android._FlxAndroidKey.FlxAndroidKey_Impl_","boot",0x12e2d014,"flixel.input.android._FlxAndroidKey.FlxAndroidKey_Impl_.boot","flixel/input/android/FlxAndroidKey.hx",13,0xd13214f4)
...
int FlxAndroidKey_Impl__obj::fromString(::String s){
            	HX_STACKFRAME(&_hx_pos_37f2223600af1802_20_fromString)
HXLINE(  21)		s = s.toUpperCase();
HXLINE(  22)		if (::flixel::input::android::_FlxAndroidKey::FlxAndroidKey_Impl__obj::fromStringMap->exists(s)) {
HXLINE(  22)			return ::flixel::input::android::_FlxAndroidKey::FlxAndroidKey_Impl__obj::fromStringMap->get_int(s);
            		}
            		else {
HXLINE(  22)			return -1;
            		}
...
::String FlxAndroidKey_Impl__obj::toString(int this1){
            	HX_STACKFRAME(&_hx_pos_37f2223600af1802_28_toString)
HXDLIN(  28)		return ::flixel::input::android::_FlxAndroidKey::FlxAndroidKey_Impl__obj::toStringMap->get_string(this1);
            	}
...
{
            	HX_STACKFRAME(&_hx_pos_37f2223600af1802_13_boot)
HXDLIN(  13)		ANY = -2;
            	}
{
...
HXDLIN(  15)		MENU = (int)1073742092;
            	}
{
            	HX_STACKFRAME(&_hx_pos_37f2223600af1802_16_boot)
HXDLIN(  16)		BACK = (int)1073742094;
            	}
}
