...
HXLINE(  84)			this->justPressedPosition->set(( (Float)(this->viewX) ),( (Float)(this->viewY) ));
...
HXDLIN(  90)				 ::flixel::math::FlxBasePoint this1 = this->justPressedPosition;
HXDLIN(  90)				 ::flixel::math::FlxBasePoint p = null();
HXDLIN(  90)				if (::hx::IsNull( p )) {
HXLINE(  90)					 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  90)					point->_inPool = false;
HXDLIN(  90)					p = point;
            				}
HXDLIN(  90)				 ::flixel::math::FlxBasePoint _hx_tmp2 = p->set(this1->x,this1->y);
HXDLIN(  90)				 ::flixel::math::FlxBasePoint _hx_tmp3 = this->getViewPosition(null(),null());
...
HXLINE( 106)		this->setRawPositionUnsafe(this->flashPoint->x,this->flashPoint->y);
            	}
