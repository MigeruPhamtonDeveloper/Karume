...
HX_DEFINE_STACK_FRAME(_hx_pos_2d8f6df4c3f42d01_92_new,"openfl.display.DisplayObjectShader","new",0x8460e16e,"openfl.display.DisplayObjectShader.new","openfl/display/DisplayObjectShader.hx",92,0x1e226044)
namespace openfl{
namespace display{

void DisplayObjectShader_obj::__construct( ::openfl::utils::ByteArrayData code){
            	HX_STACKFRAME(&_hx_pos_2d8f6df4c3f42d01_92_new)
...
HXLINE(  93)		super::__construct(code);
