...
class HXCPP_CLASS_ATTRIBUTES InputFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		::Dynamic addUniqueType_add_T_dyn();
		 ...
		 ::flixel::input::android::FlxAndroidKeys addInput_flixel_input_android_FlxAndroidKeys( ::flixel::input::android::FlxAndroidKeys input);
		::Dynamic addInput_flixel_input_android_FlxAndroidKeys_dyn();
		...
		::Dynamic addInput_flixel_input_gamepad_FlxGamepadManager_dyn();
		 ...
		 ::flixel::input::touch::FlxTouchManager addInput_flixel_input_touch_FlxTouchManager( ::flixel::input::touch::FlxTouchManager input);
		::Dynamic addInput_flixel_input_touch_FlxTouchManager_dyn();
