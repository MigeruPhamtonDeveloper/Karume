...
HX_DECLARE_STACK_FRAME(_hx_pos_9c3075758433de87_22_new)
...
HXLINE(  60)		( ( ::flixel::_hx_system::frontEnds::VCRFrontEnd)(__this) )->stepRequested = false;
HXLINE(  55)		( ( ::flixel::_hx_system::frontEnds::VCRFrontEnd)(__this) )->paused = false;
            	}
